...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, Star, Users, FileText, BarChart3, ShieldCheck, Zap } from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden bg-white font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-500 mb-8 text-sm">Join FundsERP. New accounts are assigned the Sales role by default.</p>
        ...
        <div className="relative z-10 h-full flex flex-col justify-center">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <h1 className="text-3xl lg:text-4xl font-bold mb-3 leading-tight">
              Start managing your operations command center
            </h1>
            <p className="text-indigo-200 text-base mb-8">
              Join thousands of businesses streamlining their workflow.
            </p>
